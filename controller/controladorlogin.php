    ...
    public function Acceder()
    {
        ...
        if (!empty($_POST)) {
            ...
            if ($datos->num_rows > 0) //si es mayor a cero significa que encontró el usuario.
            {
                ...
                //verifica en la base de datos cuando le estamos pasando los datos si es adiministrador  y si lo es que lo de deje acceder al contenido para admimistrar
                if ($_SESSION['TipoUsuario'] === "A") {
                    ...
                    $vista = "view/client/frmCuenta.php";
